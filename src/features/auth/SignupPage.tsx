  ...
  return (
    <AuthLayout wide>
      ...
      <p className="text-muted" style={{ fontSize: 14, margin: "0 0 22px" }}>
        Leva menos de dois minutos. Você confirma o contato por um código de
        acesso.
      </p>
            ...
            >
              ...
              >
                <KeyRound
                  size={20}
                  color={
                    role === "inquilino" ? "#fff" : "var(--color-accent-2-800)"
                  }
                  strokeWidth={2.5}
                />
              </span>
          ...
          >
            ...
            <div className="field" style={{ maxWidth: 280 }}>
              <label htmlFor="documento">
                {role === "proprietario" ? "CPF ou CNPJ" : "CPF"}
              </label>
              <input
                id="documento"
                className="input"
            ...
            {role === "inquilino" && (
              <div className="field" style={{ maxWidth: 320 }}>
                <label htmlFor="convite">
                  Código de convite do proprietário (opcional)
                </label>
                <input
                  id="convite"
                  className="input"
                  placeholder="Ex: CONVITE-8F2A"
                  value={codigoConvite}
                  onChange={(e) => setCodigoConvite(e.target.value)}
                />
                <div className="field-hint">
                  Recebeu um convite do seu proprietário? Cole o código aqui
                  para já vincular seu imóvel. Sem ele, você pode se vincular
                  depois.
                </div>
              </div>
            )}
      ...
      <div
        className="text-muted"
        style={{ fontSize: 13, marginTop: 22, textAlign: "center" }}
      >
        Já tem conta?{" "}
        <Link to="/entrar" style={{ fontWeight: 700 }}>
          Entrar
        </Link>
      </div>
    </AuthLayout>
