import type { Alerta, Chamado, Contrato, Cobranca, Imovel, User } from './types';
...
export const CONTRATOS: Contrato[] = [
  {
    ...
    eventos: [
      ...
      { titulo: 'Assinado pelo inquilino', data: '01/03/2025 14:05', detalhe: 'CPF ***.418.220-**', concluido: true },
      { titulo: 'Contrato ativo', data: 'Registrado com validade jurídica', concluido: true },
    ],
  },
  {
    ...
    eventos: [
      ...
      { titulo: 'Assinado pelo inquilino', data: '12/01/2024 16:40', detalhe: 'CNPJ ***.221.400/**', concluido: true },
      { titulo: 'Contrato ativo', data: 'Registrado com validade jurídica', concluido: true },
    ],
  },
  {
    ...
    eventos: [
      ...
      { titulo: 'Assinado pelo inquilino', data: '29/07/2024 09:30', detalhe: 'CPF ***.902.115-**', concluido: true },
      { titulo: 'Renovação pendente', data: 'Vence em 22 dias', concluido: false },
    ],
  },
  {
    id: 'ct-aurora-novo',
  ...
  },
  {
    ...
    eventos: [
      ...
      { titulo: 'Assinado pelo inquilino', data: '27/01/2024', concluido: true },
...
export const CHAMADOS: Chamado[] = [
  {
    ...
    fotos: [],
    mensagens: [
      { autor: 'Mariana Alves', texto: 'Vazamento embaixo da pia da cozinha, pingando desde ontem.', data: '21/07/2025 08:14' },
      { autor: 'Ricardo Souza', texto: 'Obrigado pelo aviso, já acionei o encanador. Deve passar aí amanhã.', data: '21/07/2025 12:40' },
    ],
  },
];

export const ALERTAS: Alerta[] = [
  { id: 'al-1', cor: 'danger', titulo: 'Aluguel de junho de Mariana Alves em atraso', detalhe: 'Rua Harmonia, 452 · há 12 dias' },
  { id: 'al-2', cor: 'accent', titulo: 'Contrato de Carlos Mendes vence em 22 dias', detalhe: 'Renovação pendente · Rua das Palmeiras, 88' },
  { id: 'al-3', cor: 'neutral', titulo: 'Novo chamado: vazamento na pia', detalhe: 'Rua Harmonia, 452 · urgência média' },
  { id: 'al-4', cor: 'accent-2', titulo: 'Pagamento recebido de Studio Reali', detalhe: 'R$ 5.800 via boleto · hoje 09:12' },
];
